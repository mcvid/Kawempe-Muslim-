...
const searchData = [
  ...
  // About
  { title: "About Us", href: "/about", category: "About", icon: "users" },
  {
    title: "Our History",
    href: "/about/history",
    category: "About",
  ...
  // News & Contact
  { title: "Latest News", href: "/news", category: "News", icon: "news" },
  {
  ...
  { title: "Press Releases", href: "/press", category: "News", icon: "news" },
  { title: "Contact Us", href: "/contact", category: "Contact", icon: "mail" },
  {
    title: "Our Location",
    href: "/location",
    category: "Contact",
