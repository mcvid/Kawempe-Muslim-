...
export default function OLevelPastPapersPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
            ...
            {/* Navigation Bar Section - Hidden on mobile */}
            <div id="library-nav-section" className="hidden md:block bg-white pt-24 pb-4">
                <LibraryNavBar />
            </div>

            {/* O Level Hero Section */}
            <PastPapersHero level="O Level" />
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-[9px] md:text-[10px] text-slate-600 font-inter leading-relaxed">
                            {papers.length} papers available for download
                        </p>
                    </motion.div>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-16 text-slate-400">
                            <p className="text-sm">No O Level past papers available yet.</p>
                        </div>
                    )}
                </div>
            </section>
