...
export default function ALevelPastPapersPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
            ...
            <PastPapersHero level="A Level" />
            <WhyChooseSection />
            <SubjectAlphabetSection level="a-level" />
            ...
            <section className="py-10 md:py-14 px-4 md:px-12 bg-slate-50">
                <div className="max-w-7xl mx-auto">
                    <motion.div className="mb-6" initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                        <h2 className="text-xs md:text-sm lg:text-base font-bold text-slate-900 mb-1 font-montserrat uppercase tracking-tight">A Level Past Papers</h2>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-16 text-slate-400"><p className="text-sm">No A Level past papers available yet.</p></div>
                    )}
                </div>
            </section>
            <Footer />
