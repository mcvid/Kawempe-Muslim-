...
const resources = [
    { id: 2, title: "A-Level Physics Formulae", type: "Guide", category: "a-level", size: "1.1 MB" },
    { id: 6, title: "Advanced Calculus", type: "Textbook", category: "a-level", size: "8.5 MB" },
];

export default function ALevelPage() {
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col font-sans pt-10">
            <h1 className="sr-only">A Level Resources</h1>
            <LibraryNavBar />
